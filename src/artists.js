...
export const ARTISTS = [
  ...
  { slug: 'mayday', group: 'group', name: '五月天', en: 'Mayday', debut: '1999-07', channelId: 'UCQyweuVOAh3NHGKDDadRSbg', wiki: '五月天', members: ['阿信', '瑪莎', '石頭', '怪獸', '冠佑'] },
  ...
  { slug: 'ma-nien-hsien', group: 'male', name: '馬念先', en: 'Ma Nien-hsien', debut: '2006', channelId: 'UCfuLDbI19x13i0pUn9iQqyA', wiki: '馬念先', groups: ['糯米糰'] },
  ...
  { slug: 'jacky-chen', group: 'male', name: '陳建瑋', en: 'Jacky Chen', debut: '2013-12', channelId: 'UCd5jew3OrvlJCU5G6CpiLBg', wiki: '陳建瑋' },
